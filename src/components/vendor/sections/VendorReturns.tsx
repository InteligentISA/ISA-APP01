...
interface VendorReturnsProps {
  vendorId: string;
}

const VendorReturns = ({ vendorId }: VendorReturnsProps) => {
  ...
  const loadReturnRequests = async () => {
    setLoading(true);
    try {
      const data = await ReturnService.getVendorReturnRequests(vendorId);
  ...
  const handleAddNotes = async (requestId: string) => {
    if (!vendorNotes.trim()) {
      toast({
        ...
        description: "Please enter some notes before submitting",
        variant: "destructive"
      });
      return;
    }
    ...
    try {
      await ReturnService.updateReturnRequest({
        ...
        status: 'pending', // Keep same status, just add notes
        vendor_notes: vendorNotes.trim()
      });

      toast({
        title: "Notes Added",
        description: "Your notes have been added to the return request",
      });
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-gray-600">Manage return requests for your products</p>
        </div>
      </div>
            ...
            <CardContent className="flex flex-col items-center justify-center py-12">
              ...
              <p className="text-gray-600 text-center">
                {searchQuery || statusFilter !== "all" 
                  ...
                  : "There are no return requests for your products at the moment."}
              </p>
            </CardContent>
          </Card>
        ) : (
        ...
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          ...
          {selectedRequest && (
            <div className="space-y-6">
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-900">{(selectedRequest.product as any)?.name}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardHeader>
                  <CardTitle>Add Vendor Notes</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Textarea
                      ...
                      placeholder="Add your notes about this return request..."
                      className="mt-1"
                      rows={3}
                    />
                  </div>
                  ...
                  <div className="flex justify-end">
                    <Button
                      ...
                      disabled={!vendorNotes.trim() || processing === selectedRequest.id}
                      className="flex items-center gap-2"
                    >
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    {selectedRequest.vendor_notes && (
                      <div>
                        <label className="text-sm font-medium text-gray-600">Your Previous Notes</label>
