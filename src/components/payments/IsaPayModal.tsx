...
import { initiateIsaPayment, getIsaPaymentStatus, IsaPayMethod } from "@/services/isaPayService";
      ...
      <DialogContent className="w-[95vw] max-w-md">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            <img src="/lovable-uploads/216ed5fd-182f-42f9-9af9-a8e6b5a633d9.png" alt="ISA Pay" className="h-6" />
