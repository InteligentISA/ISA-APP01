// Direct script to populate location data using hardcoded Supabase credentials
// Run with: node populate-location-data-direct.js

const { createClient } = require('@supabase/supabase-js');

// Using the credentials from your client.ts file
const SUPABASE_URL = "https://cwaeldxeuqxzcohnflun.supabase.co";
const SUPABASE_ANON_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImN3YWVsZHhldXF4emNvaG5mbHVuIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTA4NTQyNjYsImV4cCI6MjA2NjQzMDI2Nn0.Mq1BIhsvpT78f5TNqXaejRSnERehVfo9teJ_lk-UllY";
